          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            <div>
              ...
              <Textarea
                ...
                rows={12}
                className={
                  form.formState.errors.businessPlan ? 'border-red-500' : ''
                }
              />
              ...
              <p className="text-sm text-muted-foreground mt-2">
                Include key sections like: Executive Summary, Company
                Description, Market Analysis, Organization & Management,
                Service/Product Line, Marketing & Sales Strategy, Funding
